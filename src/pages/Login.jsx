    ...
    return (
        <form onSubmit={onSubmitHandler} className='min-h-[80vh] flex items-center'>
            <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-[#5E5E5E] text-sm shadow-lg'>
                ...
                {
                    state === 'Quản trị viên'
                        ? <p>Bác sĩ đăng nhập? <span className=' text-primary underline cursor-pointer' onClick={() => setState('Bác sĩ')}>Ấn vào đây</span></p>
                        : <p>Quản trị viên đăng nhập <span className=' text-primary underline cursor-pointer' onClick={() => setState('Quản trị viên')}>Ấn vào đây</span></p>
                }
            </div>
        </form>
    )
